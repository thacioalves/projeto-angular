...
@Component({
  selector: 'app-entregador-delete',
  templateUrl: './entregador-delete.component.html',
  styleUrls: ['./entregador-delete.component.css']
})
export class EntregadorDeleteComponent {
  formGroup: FormGroup;
